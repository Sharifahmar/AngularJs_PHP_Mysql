...
//    }
    ...
    public
        ...
        if ($table == 'add_matches') {
//            $this->_query = "SELECT * FROM `add_matches` WHERE match_date BETWEEN CURDATE() - INTERVAL 1 DAY AND CURDATE() + INTERVAL 2 DAY";
            $this->_query = "SELECT * FROM `add_matches`";
        } else {
